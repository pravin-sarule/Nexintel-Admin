...
//     <div>
//       <h1>Support & Help</h1>
//       <p>Welcome to the Support & Help section. Here you can find resources and contact information for assistance.</p>
//       <h2>Frequently Asked Questions</h2>
//       <ul>
//         <li>How do I reset my password?</li>
//         <li>Where can I find my subscription details?</li>
//         <li>How do I contact customer support?</li>
//       </ul>
//       <h2>Contact Us</h2>
//       <p>If you need further assistance, please contact us at:</p>
//       <p>Email: support@nexintel.com</p>
