...
// // API Service
// const apiService = {
//   baseURL: 'http://localhost:3000/api/admin/plans',
...
//     type: 'individual',
//     features: '',
//     limits: { documentUploads: '', aiAnalyses: '', aiDrafts: '', has_admin_console: false }
//   });
...
//       limits: {
//         documentUploads: parseInt(formData.limits.documentUploads),
//         aiAnalyses: parseInt(formData.limits.aiAnalyses),
//         aiDrafts: parseInt(formData.limits.aiDrafts),
//         has_admin_console: formData.type === 'business'
//       }
//     };
//     onSave(data);
//   };
...
//               className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
//             >
//               <option value="month">Quaterly</option>
...
//             <input
//               type="number"
//               value={formData.limits.documentUploads}
//               onChange={(e) => handleChange('limits.documentUploads', e.target.value)}
//               className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
//             />
//           </div>

//           <div>
//             <label className="block text-sm font-medium mb-1">AI Analyses *</label>
//             <input
//               type="number"
//               value={formData.limits.aiAnalyses}
//               onChange={(e) => handleChange('limits.aiAnalyses', e.target.value)}
//               className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
//             />
//           </div>

//           <div>
//             <label className="block text-sm font-medium mb-1">AI Drafts *</label>
//             <input
//               type="number"
//               value={formData.limits.aiDrafts}
//               onChange={(e) => handleChange('limits.aiDrafts', e.target.value)}
//               className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
//             />
//           </div>
...
//       limits: {
//         documentUploads: parseInt(editData.limits.documentUploads),
//         aiAnalyses: parseInt(editData.limits.aiAnalyses),
//         aiDrafts: parseInt(editData.limits.aiDrafts),
//         has_admin_console: editData.type === 'business'
//       }
//     };
//     onSave(data);
//   };
...
//               </select>
//             ) : (
//               <span className="text-sm capitalize">{plan.interval}ly</span>
//             )}
//           </div>
//         </div>

//         <div className="space-y-4">
//           <h4 className="font-medium border-b pb-2">Limits & Features</h4>
...
//               <input
//                 type="number"
//                 value={editData.limits?.documentUploads || ''}
//                 onChange={(e) => handleChange('limits.documentUploads', e.target.value)}
//                 className="w-full px-3 py-2 border rounded-lg"
//               />
//             ) : (
//               <span className="text-sm">{plan.limits?.documentUploads || 'N/A'}</span>
//             )}
//           </div>
...
//               <input
//                 type="number"
//                 value={editData.limits?.aiAnalyses || ''}
//                 onChange={(e) => handleChange('limits.aiAnalyses', e.target.value)}
//                 className="w-full px-3 py-2 border rounded-lg"
//               />
//             ) : (
//               <span className="text-sm">{plan.limits?.aiAnalyses || 'N/A'}</span>
//             )}
//           </div>
...
//               <input
//                 type="number"
//                 value={editData.limits?.aiDrafts || ''}
//                 onChange={(e) => handleChange('limits.aiDrafts', e.target.value)}
//                 className="w-full px-3 py-2 border rounded-lg"
//               />
//             ) : (
//               <span className="text-sm">{plan.limits?.aiDrafts || 'N/A'}</span>
//             )}
//           </div>
...
//               />
//             ) : (
//               <ul className="text-sm bg-gray-50 rounded p-3 list-disc list-inside">
...
//                     <td className="px-4 py-3 text-sm capitalize">{plan.interval}ly</td>
//                     <td className="px-4 py-3">
//                       <div className="flex space-x-2">
//                         <button
...
//       document_limit: parseInt(formData.document_limit || '0'),
//       ai_analysis_limit: parseInt(formData.ai_analysis_limit || '0'),
//       token_limit: parseInt(formData.token_limit || '0'),
//       carry_over_limit: formData.carry_over_limit ? parseInt(formData.carry_over_limit) : null,
//       limits: {
//         summaries: formData.limits.summaries ? parseInt(formData.limits.summaries) : null,
//         drafts: formData.limits.drafts ? parseInt(formData.limits.drafts) : null
//       }
//     };
//     onSave(data);
//   };
...
//       carry_over_limit: editData.carry_over_limit ? parseInt(editData.carry_over_limit) : null,
//       limits: {
//         summaries: editData.limits.summaries ? parseInt(editData.limits.summaries) : null,
//         drafts: editData.limits.drafts ? parseInt(editData.limits.drafts) : null
//       }
//     };
//     onSave(data);
//   };
...
// API Service
const apiService = {
  baseURL: 'https://nexintel-admin.onrender.com/api/admin/plans',
...
const PlanForm = ({ plan, onSave, onCancel, loading }) => {
  ...
  const handleSubmit = () => {
    const data = {
      ...
      carry_over_limit: parseInt(formData.carry_over_limit),
      limits: {
        summaries: parseInt(formData.limits.summaries),
        drafts: parseInt(formData.limits.drafts)
      }
    };
    onSave(data);
  };
